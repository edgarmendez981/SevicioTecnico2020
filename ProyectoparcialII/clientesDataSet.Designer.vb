...
Partial Public Class clientesDataSet
    ...
    Partial Public Class clientesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddclientesRow(ByVal Idcliente As Integer, ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String) As clientesRow
            Dim rowclientesRow As clientesRow = CType(Me.NewRow,clientesRow)
            Dim columnValuesArray() As Object = New Object() {Idcliente, nombre, apellido, correo, telefono, direccion}
    ...
    Partial Public Class clientesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `clientes` WHERE ((`Idcliente` = ?) AND ((? = 1 AND `nombre` IS NULL)"& _ 
                ...
                " ((? = 1 AND `correo` IS NULL) OR (`correo` = ?)) AND ((? = 1 AND `telefono` IS "& _ 
                "NULL) OR (`telefono` = ?)) AND ((? = 1 AND `direccion` IS NULL) OR (`direccion` "& _ 
                "= ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `clientes` (`Idcliente`, `nombre`, `apellido`, `correo`, `telefono`, "& _ 
                "`direccion`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `clientes` SET `Idcliente` = ?, `nombre` = ?, `apellido` = ?, `correo` = ?"& _ 
                ", `telefono` = ?, `direccion` = ? WHERE ((`Idcliente` = ?) AND ((? = 1 AND `nomb"& _ 
                "re` IS NULL) OR (`nombre` = ?)) AND ((? = 1 AND `apellido` IS NULL) OR (`apellid"& _ 
                "o` = ?)) AND ((? = 1 AND `correo` IS NULL) OR (`correo` = ?)) AND ((? = 1 AND `t"& _ 
                "elefono` IS NULL) OR (`telefono` = ?)) AND ((? = 1 AND `direccion` IS NULL) OR ("& _ 
                "`direccion` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ProyectoparcialII.My.MySettings.Default.clientesConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Idcliente, nombre, apellido, correo, telefono, direccion FROM clientes"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "DELETE FROM clientes" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (Idcliente = ?)"
            ...
            Me._commandCollection(2).CommandText = "UPDATE       clientes" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SET                Idcliente = ?, nombre = ?, apellido = ?" & _
                ", correo = ?, telefono = ?, direccion = ?" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (Idcliente = ?)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Idcliente", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "Idcliente", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("nombre", Global.System.Data.OleDb.OleDbType.WChar, 45, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "nombre", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("apellido", Global.System.Data.OleDb.OleDbType.WChar, 45, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "apellido", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("correo", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "correo", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("telefono", Global.System.Data.OleDb.OleDbType.WChar, 10, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "telefono", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("direccion", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "direccion", Global.System.Data.DataRowVersion.Current, False, Nothing))
            ...
            Me._commandCollection(3).CommandText = "SELECT        Idcliente, nombre, apellido, correo, telefono, direccion" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM     " & _
                "       clientes" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (Idcliente = ?)"
            ...
            Me._commandCollection(4).CommandText = "INSERT INTO clientes" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         (Idcliente, nombre, apellido, corr" & _
                "eo, telefono, direccion)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "VALUES        (?, ?, ?, ?, ?, ?)"
            ...
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("nombre", Global.System.Data.OleDb.OleDbType.WChar, 45, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "nombre", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("apellido", Global.System.Data.OleDb.OleDbType.WChar, 45, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "apellido", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("correo", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "correo", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("telefono", Global.System.Data.OleDb.OleDbType.WChar, 10, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "telefono", Global.System.Data.DataRowVersion.Current, False, Nothing))
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("direccion", Global.System.Data.OleDb.OleDbType.WChar, 50, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "direccion", Global.System.Data.DataRowVersion.Current, False, Nothing))
        End Sub
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As clientesDataSet.clientesDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As clientesDataSet.clientesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        Public Overridable Overloads Function FillBy(ByVal dataTable As clientesDataSet.clientesDataTable, ByVal Idcliente As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overridable Overloads Function GetDataBy3(ByVal Idcliente As Global.System.Nullable(Of Integer)) As clientesDataSet.clientesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            If (Idcliente.HasValue = True) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Idcliente.Value, Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As clientesDataSet.clientesDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataSet As clientesDataSet) As Integer
        ...
        Public Overridable Overloads Function Delete(ByVal Original_Idcliente As Global.System.Nullable(Of Integer), ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_correo As String, ByVal Original_telefono As String, ByVal Original_direccion As String) As Integer
            If (Original_Idcliente.HasValue = True) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_Idcliente.Value, Integer)
            Else
        ...
        Public Overridable Overloads Function Insert(ByVal Idcliente As Global.System.Nullable(Of Integer), ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String) As Integer
            If (Idcliente.HasValue = True) Then
        ...
        Public Overridable Overloads Function Update(ByVal Idcliente As Global.System.Nullable(Of Integer), ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String, ByVal Original_Idcliente As Global.System.Nullable(Of Integer), ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_correo As String, ByVal Original_telefono As String, ByVal Original_direccion As String) As Integer
            If (Idcliente.HasValue = True) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
        Public Overridable Overloads Function Update(ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String, ByVal Original_Idcliente As Global.System.Nullable(Of Integer), ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_correo As String, ByVal Original_telefono As String, ByVal Original_direccion As String) As Integer
            Return Me.Update(Original_Idcliente, nombre, apellido, correo, telefono, direccion, Original_Idcliente, Original_nombre, Original_apellido, Original_correo, Original_telefono, Original_direccion)
        End Function
        ...
        Public Overridable Overloads Function BORRAR(ByVal Idcliente As Global.System.Nullable(Of Integer)) As Integer
        ...
        Public Overridable Overloads Function EDITAR(ByVal Idcliente As Global.System.Nullable(Of Integer), ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String, ByVal Original_Idcliente As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (Original_Idcliente.HasValue = True) Then
                command.Parameters(6).Value = CType(Original_Idcliente.Value, Integer)
            Else
        ...
        Public Overridable Overloads Function INSERTAR(ByVal Idcliente As Global.System.Nullable(Of Integer), ByVal nombre As String, ByVal apellido As String, ByVal correo As String, ByVal telefono As String, ByVal direccion As String) As Integer
